...
export default function BuyPage() {
  ...
  useEffect(() => {
    // Set page title
    document.title = 'BlueStoneX / Buy a Business';
  }, []);
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-6 pt-24">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Buy a Business</h1>
          <p className="text-white/70 text-lg mb-8">
            BlueStoneX is building a modern marketplace where entrepreneurs can discover business acquisition opportunities.
          </p>
          ...
          {isSubmitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {isSubmitting ? 'Submitting...' : 'Join Buyer Waitlist'}
              </button>
            </form>
          )}
        </motion.div>
